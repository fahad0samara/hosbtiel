...
export default function RegisterPatient() {
 const { setlogPatient, setProfile, dark, Profile, setPatient, setlogAdmin, setlogDr } = useLogIN()

 // get the id emile pasword and put ot in the form
 const { _id, email, password } = Profile

 console.log('🚀 ~ file: RegisterPatient.tsx ~ line 6 ~ RegisterPatient ~ Profile', _id)
 ...
 const [diseaseList, setDiseaseList] = useState([{ disease: '', YearRound: '' }])
 ...
 const handleRegisterPatient = async (e: { preventDefault: () => void }) => {
  ...
  try {
   const response0 = await axios.post('http://localhost:3000/user/register-patient', {
    user: _id,
    name,
    date,
    mobile,
      ...
      <div>
       <div
        className="
              ...
              "
       >
        <label className="font-bold lg:text-xl font-poppins lg:px-4 lg:my-4 ">Name</label>
        <div
         className="
               flex
              md:flex-row
        ...
        <div
         className="
              ...
              items-center
                "
        >
         <label className="font-bold lg:text-xl px-4 ">Mobile Number</label>
...
"
       ...
       >
        ...
        <div className="col-span-4">
         {diseaseList.map((disease, index) => {
          return (
           <div key={index} className="grid grid-cols-7 col-span-1 mb-3">
            <input
             className="lg:h-10
                               lg:w-64
                                text-black
      ...
      >
       <div className="col-span-5 ">
        <h1 className=" lg:text-xl  my-1 font-bold px-4 grid col-start-1 col-span-3">do you have any allergy</h1>
       </div>
       <div className="col-span-4  ">
      ...
      >
       <div className="col-span-5 ">
        <h1 className=" lg:text-xl   font-bold px-4 grid col-start-1 col-span-3">do you have any medication</h1>
       </div>
       <div className="col-span-4  ">
      ...
      <div>
       <div className="flex justify-center">
        <h1 className=" p-4 rounded font-bold lg:text-3xl text-xl mt-2">Emergency Contact Details</h1>
       </div>
       ...
       >
        <div
         className="
              ...
              "
        >
         <label className="font-bold lg:text-xl px-4 ">Phone Number</label>
         <input
          type="tel"
       ...
       >
        <div
         className="  flex
              ...
              text-center"
        >
         <label className=" rounded p-2 lg:text-xl font-bold px-4">age</label>
         <input
          type="date"
          className=" 
...
"
        ...
        <div
         className="  flex
              ...
              text-center"
        >
         <label className=" rounded p-2 lg:text-xl font-bold px-4">Relation / connection</label>
         <input
          className=" 
...
"
       ...
       <div
        className="
              ...
              items-center "
       >
        <label className=" lg:text-xl font-bold px-4 mb-8 col-span-1">Address</label>
        <div
         className="   grid 
                  lg:grid-cols-3
                  md:grid-cols-2
       ...
       <div className="flex justify-center mb-4 mt-8">
        {Loading ? (
         <button className="bg-blue-500 text-white font-bold py-2 px-4 rounded" type="button" disabled>
          <svg
