 ...
 return (
  <div className="ml-16 ">
   <div className="mt-12 flex flex-col justify-center ">
    ...
    <p className="text-sm font-normal text-gray-500 mt-2 lg:ml-5">Check your every situation </p>
    <p className="text-sm font-normal text-gray-500  ml-12">and your actives</p>
