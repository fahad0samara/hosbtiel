           ...
           return (
            ...
            >
             ...
             <div className="flex items-center px-2 py-3">
              <img className="object-cover w-10 h-10 rounded-full" alt="User avatar" src={patients.avatar} />
              ...
              <div className="flex items-center ">
               <div className="">
                <h3 className=" hover:text-blue-400 hover:underline">{patients.bloodGroup}</h3>
               </div>
               <div className="mx-3 sm:block hidden">
                <h3 className=" hover:text-blue-400 hover:underline">{patients.mobile}</h3>
               </div>
               <div className="mx-3 sm:block hidden">
