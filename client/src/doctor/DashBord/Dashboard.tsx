   ...
   <div className="p-5 mx-20">
    <div className="flex flex-col my-3">
     <h1 className="text-2xl font-bold">
      {message} ,<span className="text-cyan-300 font-bold ml-1">Dr.{Doctor && Doctor.name.firstName}</span>
     </h1>
          ...
          >
           ...
           >
            <h1 className=" italic text-sm">
             patient Name : {appointmentData.currentAppointment.patient.name.firstName}
             {'  '}
             {appointmentData.currentAppointment.patient.name.LastName}
            </h1>
            {appointmentData.currentAppointment.patient.symptoms &&
             appointmentData.currentAppointment.patient.symptoms.map((symptom, index) => (
              <span key={index} className="text-sm italic mr-2 text-gray-400">
               {symptom}
              </span>
             ))}
           </div>
       ...
       {appointmentData.currentAppointment ? (
        <div
         style={{
          backgroundColor: dark ? '#000' : '#fff',
          color: dark ? 'white' : 'black',
          boxShadow: dark ? '0px 0px 5px 0px #ccc' : '0px 0px 10px 4px #ccc',
         }}
         className=" 
                shadow-md
        ...
        >
         ...
         <div className="space-y-2 ">
          <h1 className="text-xl font-bold text-center ">Next Appointment</h1>
            ...
            <div className="flex flex-col mx-2 space-y-3">
             <div className="space-x-2 flex">
              ...
              <h1 className="text-lg font-semibold  ml-1 bg-white shadow-black text-black shadow-md rounded-sm  w-auto  text-center px-1">
               {formatDate(appointmentData.currentAppointment.appointmentDate)}
              </h1>
             </div>
             <div
              className="
             ...
             >
              ...
              <h1 className="text-lg font-semibold  ml-1 bg-white shadow-black text-black shadow-md rounded-sm  w-auto  text-center px-1">
               ...
               {appointmentData.currentAppointment.patient
                ? appointmentData.currentAppointment.patient.name.firstName
                : 'No patient'}{' '}
               {appointmentData.currentAppointment.patient
                ? appointmentData.currentAppointment.patient.name.LastName
                : 'No patient'}
