 ...
 return (
  <div className="fixed inset-0 z-10 overflow-y-auto bg-gray-900 bg-opacity-50">
   <div className="flex items-center justify-center min-h-screen">
    ...
    >
     <div className="p-6">
      <h1 className="text-2xl font-bold mb-4 text-cyan-300 ">Appointment Details</h1>
      <p className="border-b-2  w-48 mx-auto"></p>
      <div className="mb-4">
       <p className="font-semibold text-cyan-300">patient:</p>
       <p>
        {appointmentData.patient.name.firstName} {appointmentData.patient.name.lastName}
       </p>
      </div>
      <div className="mb-4">
       <p>
        ...
        {appointmentData.patient.symptoms &&
         appointmentData.patient.symptoms.map((symptom, index) => (
      ...
      <div className="mb-4">
       ...
       <p>{appointmentData.appointmentDate.split('T')[0].split('-').reverse().join('-')}</p>
      </div>
      <div className="mb-4">
      ...
      <p className="text-sm text-center  italic">
       Please arrive on time for your appointment. If you are running late, please call the office to let us know.
      </p>
     </div>
     <div
