  ...
  return (
    ...
    >
      <div
        ...
        className="
    w-full max-w-4xl shadow-cyan-300 rounded-2xl p-4 mx-auto my  my-20"
      >
        {errorMessage && (
          <div
        ...
        <div className="flex items-center justify-between">
          <span className="text-gray-600 dark:text-gray-300">Prescription</span>
        </div>

        <h1 className="text-xl font-bold capitalize ctext-white">
          Add Prescription
        </h1>
        <h1>
          {loading ? (
