  ...
  >
   ...
   >
    ...
    <div className="flex items-center justify-between ml-40 md:ml-0">
     <span className="text-gray-600 dark:text-gray-300 text-center">Prescription</span>
    </div>

    <h1 className="text-xl font-bold capitalize  text-center md:text-start">Add Prescription</h1>
    <h1>
     {loading ? (
