...
const Modal = ({ show, handleClose, handleCreate, eventTitle }) => {
 const [title, setTitle] = useState(eventTitle)

 const showHideClassName = show ? 'fixed z-10 inset-0 overflow-y-auto' : 'hidden'
      ...
      <div className="sm:flex sm:items-start">
       <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-100 sm:mx-0 sm:h-10 sm:w-10">
        <svg className="h-6 w-6 text-blue-600" stroke="currentColor" fill="none" viewBox="0 0 24 24">
         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 14l6-6m0 0l-6-6m6 6v12" />
        </svg>
       </div>
