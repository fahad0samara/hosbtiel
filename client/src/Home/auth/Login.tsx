...
const Login = () => {
 const { setProfile, setlogDr, setLoading, setlogAdmin, setlogPatient, dark, setdark, setDoctor, setPatient } =
  useLogIN()
  ...
  try {
   ...
   if (axios.isAxiosError(error)) {
    ...
    if (showError) {
     ...
     setLoading(false)
     console.log('🚀 ~ file: RegisterAdmin.tsx ~ line 64 ~ HandelLogin ~ error', error)
    }
   } else {
    // Handle the unknown
    console.log('🚀 ~ file: RegisterAdmin.tsx ~ line 64 ~ HandelLogin ~ error', error)
