...
const RegisterDr = () => {
 ...
 const { logPatient, Profile, setProfile, dark, setdark, setlogAdmin, setlogDr, setlogPatient, setPatient } = useLogIN()
        ...
        <div>
         ...
         >
          <div className="text-center mb-6">
           ...
           <p className="text-md font-bold  ">Please fill in this form to create an account!</p>
          </div>
         </div>
         <div
          className="
              ...
              "
         >
          <label className="font-bold lg:text-xl font-poppins text-center   lg:my-4  col-span-1">Name</label>
          <div
           className="
                          col-span-2
               flex
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 md:gap-16 gap-5 my-3 max-w-2xl">
          <div>
           <label className="font-bold lg:text-xl font-poppins lg:px-2 lg:my-1 ">Date of Birth</label>
           <input
            type="date"
            className="appearance-none bg-transparent  border-b-2 border-cyan-400 w-full  mr-3 py-1 px-2 leading-tight focus:outline-none"
            required
          ...
          <div>
           <label className="font-bold lg:text-xl  ">Mobile Number</label>
        ...
        <div>
         <div
          className="flex
              ...
              "
         >
          <h1 className=" font-bold lg:text-3xl text-xl ">Emergency Contact Details</h1>
         ...
         >
          <label className="font-bold lg:text-xl lg:text-start  text-center">Name</label>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 md:gap-16 gap-5 my-3 max-w-2xl">
          ...
          <div>
           <label className="font-bold lg:text-xl  ">Relation/ Relationship</label>
