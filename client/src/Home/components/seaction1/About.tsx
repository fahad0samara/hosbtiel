 ...
 return (
  <section className="">
   <div className="mx-auto max-w-xl px-4 py-10 text-gray-600 lg:max-w-screen-lg">
    <h2 className="mb-8 text-3xl font-bold text-teal-800 lg:mb-20 lg:text-center lg:text-5xl">Employee Benefits</h2>
    <div className="flex flex-col lg:flex-row">
     <div className="self-center pr-5 lg:w-1/2">
      <p className="mb-4 text-base">
       Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel eos amet laborum iste distinctio modi soluta fuga
       officia odio laudantium?
      </p>
      <p className="mb-4 text-base">
       Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis et maiores ex numquam repellat? Iure, illum
       illo nisi explicabo deleniti amet sapiente repudiandae blanditiis ullam esse nostrum neque eveniet impedit
       nesciunt, sint inventore reprehenderit cumque! Vero dolor facere cumque ad.
      </p>
       ...
       <div className="mr-3 rounded-full bg-teal-100 p-6 text-7xl text-teal-800">
        ...
        >
         <path
          fill="currentColor"
          fill-rule="evenodd"
          d="M17 7a3 3 0 0 1 3-3h8a3 3 0 0 1 3 3h3a3 3 0 0 1 3 3v16h-2V10a1 1 0 0 0-1-1h-3a3 3 0 0 1-3 3h-8a3 3 0 0 1-3-3h-3a1 1 0 0 0-1 1v28a1 1 0 0 0 1 1h10v2H14a3 3 0 0 1-3-3V10a3 3 0 0 1 3-3h3Zm3-1a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-8Zm3 10v3h-3v2h3v3h2v-3h3v-2h-3v-3h-2Zm1 13.665v4a1 1 0 0 0 1 1h4v-2h-1.475l1.253-1.178a5 5 0 0 1 8.273 1.845l1.885-.667a7.001 7.001 0 0 0-11.538-2.625L26 31.353v-1.688h-2Zm11.667 5.667h4a1 1 0 0 1 1 1v4h-2v-1.688l-1.398 1.313a7 7 0 0 1-11.538-2.625l1.885-.667a5 5 0 0 0 8.273 1.845l1.253-1.178h-1.475v-2Z"
          clip-rule="evenodd"
         />
        </svg>
       </div>
