import { FaRegMoneyBillAlt, FaStethoscope } from 'react-icons/fa'
...
const About = () => {
 ...
 const items = [
  {
   icon: <AiOutlineStar size={26} />,
   title: 'Reputation',
   description:
    "We have a reputation for providing exceptional care and delivering positive patient outcomes. Our patients' satisfaction is our top priority, and we work hard to ensure that each patient receives personalized attention and care.",
  },
  {
   icon: <FaStethoscope size={26} />,
   title: 'Specialties',
   description:
    'We offer a wide range of medical specialties, including cardiology, neurology, and cancer treatment. Our team of skilled physicians and specialists are experts in their respective fields, providing patients with the best possible care.',
  },
  {
   icon: <MdLocationOn size={26} />,
   title: 'Location',
   description:
    'We are conveniently located and easily accessible, making it easy for patients to receive the care they need. Our hospital is situated in a prime location, with excellent transportation links and ample parking facilities.',
  },
  {
   icon: <FaRegMoneyBillAlt size={26} />,
   title: 'Facilities and amenities',
   description:
    'Our hospital is equipped with state-of-the-art facilities and amenities, including private rooms, specialized equipment, and support services. We strive to create a comfortable and welcoming environment for our patients, helping them to feel relaxed and at ease during their stay.',
  },
 ]
 ...
 return (
  ...
  >
   <div className="mx-auto  w-full max-w-screen-xl px-4 py-4">
    <div className=" w-20 border-b-2 border-cyan-300 lg:border-b-4"></div>
    <h2 className="mt-6 mb-10 text-2xl italic font-semibold tracking-wide  sm:text-4xl">Why Choose Our Hospital</h2>
    <div className="flex flex-col justify-between lg:flex-row lg:flex-wrap">
     {items.map((item, index) => (
      <motion.div
       ...
       className="mt-8 lg:mt-10 lg:w-1/2"
      >
       <div className="flex flex-col items-start lg:pr-16">
        <motion.div
         ...
         className="inline-flex items-center justify-center w-12 h-12 rounded-md bg-cyan-300 text-white"
        >
         {item.icon}
        </motion.div>

        <h2 className="lg: mt-6 flex items-center text-base font-semibold tracking-wide  lg:mt-6 lg:text-2xl">
         <span className="mr-5 text-2xl">{item.title}</span>
        </h2>
        <p className="lg: mt-1 text-sm tracking-normal  lg:mt-1 lg:text-xl italic">{item.description}</p>
       </div>
      </motion.div>
     ))}
    </div>
   ...
   <section className="">
    <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
     ...
     <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 italic text-cyan-300">
       <span className="relative inline-flex justify-center whitespace-nowrap font-bold">
        <svg
         className="absolute -bottom-8 hidden w-2/3 text-yellow-400 sm:block"
         viewBox="0 0 490 42"
         fill="none"
      ...
      <p className="mb-8 leading-relaxed italic mt-6">
       "We're here to help you feel your best. Don't wait to get the care you need - schedule your appointment today and
       take the first step towards a healthier you. Contact us now to schedule your appointment."
      </p>
      <div className="flex justify-center">
       <Link to="/login" className="relative px-6 py-3 font-bold text-white rounded-lg group">
        ...
        <span className="absolute inset-0 w-full h-full transition duration-300 transform translate-x-1 translate-y-1 bg-cyan-300 ease opacity-80 group-hover:translate-x-0 group-hover:translate-y-0 mix-blend-screen"></span>
