 ...
 const options0 = {
  ...
  series: [
   ...
   },
   {
    ...
    data: [chartData.patientAvg, chartData.doctorAvg, chartData.prescriptionAvg, chartData.appointmentAvg],
   },
  ],
 }
 useEffect(() => {
  ...
  <div className="my-7">
   <div className="grid lg:grid-cols-4  gap-8 lg:mx-24 md:grid-cols-2  px-20 mx-12  sm:px-11 ">
    ...
    >
     ...
     <h1 className="text-2xl text-white">{numPatients ? numPatients : 'loading...'}</h1>
    </div>
    ...
    >
     ...
     <h1 className="text-2xl text-white">{numDoctors ? numDoctors : 'loading...'}</h1>
    </div>
    <div
     style={{
      boxShadow: dark ? '0px 0px 10px 0px #fff' : '0px 0px 10px 0px #000',
    ...
    >
     ...
     <h1 className="text-2xl text-white">{appointments ? appointments : 'Loading...'}</h1>
    </div>
   </div>
   <h1 className="text-2xl text-center my-5 text-cyan-300 italic hidden sm:block">Total and Average</h1>
   <div className="  lg:grid-cols-2 gap-3 sm:mx-24 mx-7 ml-10 hidden sm:grid">
    ...
    {chartData ? (
     <HighchartsReact className="" highcharts={Highcharts} options={options0} />
    ) : (
     <div>
      <h1 className="text-2xl text-center my-5">Loading...</h1>
     </div>
