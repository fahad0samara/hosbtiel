...
import { BsArrowLeftCircleFill, BsArrowRightCircleFill, BsInfoCircle } from 'react-icons/bs'
 ...
 return (
  <div
   ...
   className="my-3
      ...
      "
  >
   <h1 className="text-2xl font-bold text-center my-3 text-cyan-300">patient list</h1>
   {
    ...
    lastPatient && lastPatient.length > 0 ? (
           ...
           return (
            <tbody key={patients._id} className={' text-sm font-light'}>
             <tr className={'border-b border-gray-200 hover:bg-gray-100 hover:text-black'}>
              ...
              <td className=" ">
               <div className="mr-6 text-center">{patients.address.city}</div>
              </td>
              <td className=" ">
               <div className="mr-6 text-center">{patients.bloodGroup}</div>
              </td>
              <td className=" ">
     ...
     <p className="text-gray-500 text-center ml-11">The doctor does not have any patients</p>
    )
   }
          ...
          <div className="">
           <span
            className={`py-1 px-2 rounded-full text-white text-md text-center border-b border-gray-100 hover:bg-black hover:text-white ${
             patients.healthIDNumber % 2 === 0 ? 'bg-red-500' : 'bg-green-500'
            }`}
           >
